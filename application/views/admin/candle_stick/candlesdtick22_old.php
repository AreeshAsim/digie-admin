...
<div id="content" style="margin-top: 111px">
    ...
    <div class="right_filter_box">
        ...
        <div class="right_filter_iner">
            ...
            <label for="sel1">percentile-type:</label>
            <select class="form-control" id="percentile-type">
            ...
            <select class="form-control" id="percentile">
            ...
            <div class="col-md-2 form-group">
            <label for="sel1">Input Offset Radius:</label>
            <input type="number" id="radius" value="5" class=" form-control">
            </div>
                    <div class="col-md-2 form-group">
                <div class="clearfix-custom"></div>
            
                    <button type="button" class="btn btn-primary refresh-percentiles">
                    <span class="glyphicon glyphicon-refresh back_word_sh_hide1"> </span> Refresh percentiles
                    <i class="fa fa-spinner fa-spin span_hd_show1" style="font-size:24px;display: none;"></i>
                    </button>
                    </div>                    
