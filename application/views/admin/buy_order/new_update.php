    ...
    $(document).ready(function(){
        $("#array_btn").click(function(){
            ...
            $.ajax({
                    ...
                    data: { orderid1: order_id1, userid1: user_id1, exchange1: exchange1 },
                    type: "POST",
                    success: function(datajson) {
                        $this.button('reset');
    ...
    $("#delete_btn").click(function(){
        ...
        if(res == '1'){
            ...
            $.ajax({
                    ...
                    data: { order_id2: order_id2, user_id2: user_id2, exchange2: exchange2 },
                    type: "POST",
                    success: function(datajson) {
                    $this.button('reset');
    ...
    $('#sell_order_id').click(function(){
        ...
        if(res == '1'){
            ...
            $.ajax({
                    ...
                    data: { order_id: order_id, user_id: user_id, exchange: exchange},
                    type: "POST",
                    success: function(datajson) {
                        $this.button('reset');
