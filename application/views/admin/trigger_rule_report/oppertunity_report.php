              ...
              foreach ($value1 as $value){
                ...
                ?>
                  <tr style="text-align:center;"> 
                    <td>
                      <img class="img img-circle" src="https://admin.digiebot.com/assets/coin_logo/thumbs/<?php echo $coinImage ; ?>" data-toggle="tooltip" data-placement="top" alt="<?php echo $value['coin'];?>" title="<?php echo $value['coin']; ?>">
                       <br><br>
                       <?php echo $value['coin']; ?>
                    </td>
                    ...
                    <?php if(number_format($compeletion, 2) == 0): ?>
                      <?php if(isset($value['is_modified']) || isset($value['oppertunity_missed'])):
                        $total_oops_missed++; ?>
                          <td>
                            <span title = "purchase price = <?php echo number_format($value['purchase_price'], 10); ?>"> 
                              ...
                              <br><br>
                              <?php if($value['reumed_child'] > 0){?>
                                <span class="label label-info">resumed <?php echo $value['reumed_child'];?></span>  
                              <?php } ?>
                      ...
                      <?php endif; ?>
                      <?php if(!isset($value['oppertunity_missed'])):?>
                          <td>
                              <span title = "purchase price = <?php echo number_format($value['purchase_price'], 10); ?>"> 
                    ...
                    <?php endif; ?>
                    <td><?php if(isset($value['sold'])){echo $value['sold'];}?></td>
                    <td><?php if(isset($value['open_lth'])){echo $value['open_lth'];} ?></td>
