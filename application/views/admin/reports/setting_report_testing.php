                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="Input_text_s coin_filter">
                                ...
                                <select id="filter_by_coin" name="filter_by_coin" type="text" class="form-control filter_by_name_margin_bottom_sm">
                                    <option value="" <?=(($filter_user_data1['filter_by_coin'] == "") ? "selected" : "")?>>Search By Coin Symbol</option>
                                    <?php
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="Input_text_s">
                                ...
                                <select id="filter_by_admin" name="filter_by_admin" type="text" class="form-control filter_by_name_margin_bottom_sm">
                                    <option value="" <?=(($filter_user_data1['filter_by_admin'] == "") ? "selected" : "")?>>Search By Admin</option>
                                    <?php
...
?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="Input_text_s">
                                ...
                                <input id="filter_by_name" name="filter_by_name" type="text" class="form-control" value="<?=$filter_user_data1['filter_by_name']?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="Input_text_s">
                                <label>Number of Days More then</label>
                                <input id="filter_by_days" name="filter_by_days" type="text" class="form-control" value="<?=$filter_user_data1['filter_by_days']?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="Input_text_s">
                                <label>Result Percentage more then</label>
                                <input id="filter_by_percentage" name="filter_by_percentage" type="text" class="form-control" value="<?=$filter_user_data1['filter_by_percentage']?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="Input_text_s">
                                <label>Target Profit More then</label>
                                <input id="filter_by_profit" name="filter_by_profit" type="text" class="form-control" value="<?=$filter_user_data1['filter_by_profit']?>">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4">
                            <div class="Input_text_s">
                                <label>Stop Loss More then</label>
                                <input id="filter_by_loss" name="filter_by_loss" type="text" class="form-control" value="<?=$filter_user_data1['filter_by_loss']?>">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12">
                            <div class="col-xs-12 col-sm-12 col-md-6 ax_4">
                                <div class="Input_text_s">
                                    ...
                                    <input id="filter_by_start_date" name="filter_by_start_date" type="text" class="form-control datetime_picker filter_by_name_margin_bottom_sm" placeholder="Search By Date" value="<?=(!empty($filter_user_data1['filter_by_start_date']) ? $filter_user_data1['filter_by_start_date'] : "")?>" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 ax_5">
                                <div class="Input_text_s">
                                    ...
                                    <input id="filter_by_end_date" name="filter_by_end_date" type="text" class="form-control datetime_picker filter_by_name_margin_bottom_sm" placeholder="Search By Date" value="<?=(!empty($filter_user_data1['filter_by_end_date']) ? $filter_user_data1['filter_by_end_date'] : "")?>" autocomplete="off">
                                </div>
                            </div>
                                ...
                                <div class="colpanel-b">
                                    ...
                                    <div class="col-xs-12 col-sm-12 old" style="display: none;">
                                      ...
                                      <div class="Input_text_s">
                                         ...
                                         <select id="<?php echo $row['setting_id'] ?>filter_search" name="filter_search" type="text" class="chosen-select" tabindex="4">
                            ...
                            <div class="colpanel">
                                ...
                                <div class="colpanel-h">
                                    ...
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <input type="radio" class="radiobtn1" id="<?php echo $row['setting_id'] ?>radio1" name="radio-category2" value="new_category" checked="" />
                                    ...
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <input type="radio" class="radiobtn1" id="<?php echo $row['setting_id'] ?>radio2" name="radio-category2" value="history_category" />
                                ...
                                <div class="colpanel-b">
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        ...
                                        <div class="Input_text_s old2"  style="display: none;">
                                             ...
                                             <select id="<?php echo $row['setting_id'] ?>filter_search" name="category_search" type="text" class="form-control">
                        ...
                        <div class="col-xs-12">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s coin_filter">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>filter_by_coin" name="filter_by_coin" type="text" class="form-control filter_by_name_margin_bottom_sm" required="required">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>black_wall_percentile" name="black_wall_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>sevenlevel_percentile" name="sevenlevel_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>big_buyers_percentile" name="big_buyers_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>big_sellers_percentile" name="big_sellers_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>five_buy_sell_percentile" name="five_buy_sell_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>fifteen_buy_sell_percentile" name="fifteen_buy_sell_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>last_qty_buy_sell_percentile" name="last_qty_buy_sell_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>last_qty_time_percentile" name="last_qty_time_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>last_qty_time_fif_percentile" name="last_qty_time_fif_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>virtual_barrier_percentile_ask" name="virtual_barrier_percentile_ask" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>virtual_barrier_percentile" name="virtual_barrier_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>bid_percentile" name="bid_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select id="<?php echo $row['setting_id'] ?>ask_percentile" name="ask_percentile" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" name="move" id="<?php echo $row['setting_id'] ?>move" value="<?=$filter_user_data['move']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <label class="full-label">Move: <small class="pullright">
                                  ...
                                  <select class="form-control" id="<?php echo $row['setting_id'] ?>move_color" name="move_color[]" multiple="true">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select class="form-control" id="<?php echo $row['setting_id'] ?>big_contractors" name="big_contractors">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <label class="full-label">Big Contractors Delta: <small class="pullright">Big Contractor
                                  ...
                                  <input type="text" class="form-control" name="big_contractors_val" id="<?php echo $row['setting_id'] ?>big_contractors_val" value="<?=$filter_user_data['big_contractors_val']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select class="form-control" id="<?php echo $row['setting_id'] ?>big_buyers" name="big_buyers">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <label class="full-label">Big Buyers Value: <small class="pullright">Big Buyers
                                  ...
                                  <input type="text" class="form-control" name="big_buyers_val" id="<?php echo $row['setting_id'] ?>big_buyers_val" value="<?=$filter_user_data['big_buyers_val']?>">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select class="form-control" id="<?php echo $row['setting_id'] ?>big_sellers" name="big_sellers">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <label class="full-label">Big Sellers Value: <small class="pullright">Big Sellers
                                  ...
                                  <input type="text" class="form-control" name="big_sellers_Val" id="<?php echo $row['setting_id'] ?>big_sellers_val" value="<?=$filter_user_data['big_sellers_Val']?>">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-2" style="">
                                    ...
                                    <div class="Input_text_s">
                                        ...
                                        <select class="form-control" id="<?php echo $row['setting_id'] ?>last_candle_percentile_buy" name="last_candle_percentile_buy">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-2" style="">
                                    ...
                                    <div class="Input_text_s">
                                        ...
                                        <select class="form-control" id="<?php echo $row['setting_id'] ?>last_candle_percentile_sell" name="last_candle_percentile_sell">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select class="form-control" id="<?php echo $row['setting_id'] ?>candle_status" name="candle_status[]" multiple="true">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select class="form-control" id="<?php echo $row['setting_id'] ?>swing_status" name="swing_status[]" multiple="true">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select class="form-control" id="<?php echo $row['setting_id'] ?>candle_type" name="candle_type[]" multiple="true">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <select class="form-control" id="<?php echo $row['setting_id'] ?>rejection" name="rejection[]" multiple="true">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" name="total_volume" id="<?php echo $row['setting_id'] ?>total_volume" value="<?=$filter_user_data['total_volume']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" name="caption_option" id="<?php echo $row['setting_id'] ?>caption_option" value="<?=$filter_user_data['caption_option']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" name="caption_score" id="<?php echo $row['setting_id'] ?>caption_score" value="<?=$filter_user_data['caption_score']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" name="buy" id="<?php echo $row['setting_id'] ?>buy" value="<?=$filter_user_data['buy']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>sell" name="sell" value="<?=$filter_user_data['sell']?>">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>demand" name="demand" value="<?=$filter_user_data['demand']?>">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>meta_trending" name="meta_trending" value="<?=$filter_user_data['meta_trending']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>risk_per_share" name="risk_per_share" value="<?=$filter_user_data['risk_per_share']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>rl" name="rl" value="<?=$filter_user_data['rl']?>">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>target_profit" name="target_profit" value="<?=$filter_user_data['target_profit']?>" required="required">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>target_stoploss" name="target_stoploss" value="<?=$filter_user_data['target_stoploss']?>" required="required">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input id="<?php echo $row['setting_id'] ?>filter_by_start_date" name="filter_by_start_date" type="text" class="form-control datetime_picker filter_by_name_margin_bottom_sm" placeholder="Search By Date" value="<?=(!empty($filter_user_data['filter_by_start_date']) ? $filter_user_data['filter_by_start_date'] : "")?>" autocomplete="off">
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-2" style="">
                              ...
                              <div class="Input_text_s">
                                 ...
                                 <input id="<?php echo $row['setting_id'] ?>filter_by_end_date" name="filter_by_end_date" type="text" class="form-control datetime_picker filter_by_name_margin_bottom_sm" placeholder="Search By Date" value="<?=(!empty($filter_user_data['filter_by_end_date']) ? $filter_user_data['filter_by_end_date'] : "")?>" autocomplete="off" required="required">
                                 ...
                                 <i class="glyphicon glyphicon-calendar"></i>
                                   ...
                                   <div class="col-xs-12">
                                    ...
                                    <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>wick_check" name="wick_check" value="yes" <?=$filter_user_data['wick_check'] == 'yes' ? "checked" : ""?>>
                                    ...
                                    <div class="colpanel-b candle_w" style="border-bottom: 1px solid rgb(238, 238, 238); margin-top: 15px;">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>wick_percentile" name="wick_percentile">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>wick_qty" name="wick_qty" value="<?=$filter_user_data['wick_qty'] != '' ? $filter_user_data['wick_qty'] : ""?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>total_volume" name="total_vol_percentile">
                          ...
                          <option value="100" <?=$filter_user_data['total_vol_percentile'] == '100' ? "selected" : ""?>>Top 100%</option>
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>curr_hr_percentile" name="curr_hr_percentile">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>curr_hr_val" name="curr_hr_val">
                                  ...
                                  <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                    ...
                                    <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>top3_contracts" name="top3_contracts" value="yes" <?=$filter_user_data['top3_contracts'] == 'yes' ? "checked" : ""?>>
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="number" class="form-control" placeholder="no of contractss" id="<?php echo $row['setting_id'] ?>no_of_contracts" name="no_of_contracts" value="<?=$filter_user_data['no_of_contracts']?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>check_wick_below" name="check_wick_below">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="colpanel">
                                    ...
                                    <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>candle_chk" name="candle_chk" value="yes" <?php if ($filter_user_data['candle_chk'] == 'yes') {echo "checked";}?>>
                                    ...
                                    <div class="colpanel-b candle" style="border-bottom:1px solid #eee; margin-top:15px; <?php if ($filter_user_data['candle_chk'] == 'yes') {echo "display:block";} else {echo "display:none";}?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>candle_range" name="candle_range" value="<?=$filter_user_data['candle_range']?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>candle_side" name="candle_side">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>formula" name="formula">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>side" name="side">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="colpanel">
                                    ...
                                    <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                         ...
                                         <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>candle_chk_h" name="candle_chk_h" value="yes" <?php if ($filter_user_data['candle_chk_h'] == 'yes') {echo "checked";}?>>
                                    ...
                                    <div class="colpanel-b candle_h" style="border-bottom:1px solid #eee; margin-top:15px; <?php if ($filter_user_data['candle_chk_h'] == 'yes') {echo "display:block";} else {echo "display:none";}?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>candle_range_h" name="candle_range_h" value="<?=$filter_user_data['candle_range_h']?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>candle_side_h" name="candle_side_h">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>formula_h" name="formula_h">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>side_h" name="side_h">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="colpanel">
                                    ...
                                    <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                         ...
                                         <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>opp_chk" name="opp_chk" value="yes" <?php if ($filter_user_data['opp_chk'] == 'yes') {echo "checked";}?>>
                                    ...
                                    <div class="colpanel-b deeply" style="border-bottom:1px solid #eee; margin-top:15px; <?php if ($filter_user_data['opp_chk'] == 'yes') {echo "display:block";} else {echo "display:none";}?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>deep_price_check" name="deep_price_check" value="<?=$filter_user_data['deep_price_check']?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>deep_price_lookup_in_hours" name="deep_price_lookup_in_hours" value="<?=$filter_user_data['deep_price_lookup_in_hours']?>">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="colpanel">
                                    ...
                                    <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                         ...
                                         <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>barrier_check" name="barrier_check" value="yes" <?php if ($filter_user_data['barrier_check'] == 'yes') {echo "checked";}?>>
                                    ...
                                    <div class="colpanel-b barrier" style="border-bottom:1px solid #eee; margin-top:15px; <?php if ($filter_user_data['barrier_check'] == 'yes') {echo "display:block";} else {echo "display:none";}?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>barrier_range" name="barrier_range" value="<?=$filter_user_data['barrier_range']?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>barrier_side" name="barrier_side">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>barrier_type" name="barrier_type">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="colpanel">
                                    ...
                                    <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                         ...
                                         <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>candle_wick" name="candle_wick" value="yes" <?php if ($filter_user_data['candle_wick'] == 'yes') {echo "checked";}?>>
                                    ...
                                    <div class="colpanel-b wick" style="border-bottom:1px solid #eee; margin-top:15px; <?php if ($filter_user_data['candle_wick'] == 'yes') {echo "display:block";} else {echo "display:none";}?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>candle_typ" name="candle_typ">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select class="form-control" id="<?php echo $row['setting_id'] ?>wick_side" name="wick_side">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" id="<?php echo $row['setting_id'] ?>wick_size" class="form-control" name="wick_size" value="<?=$filter_user_data['wick_size']?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" id="<?php echo $row['setting_id'] ?>wick_lookup" class="form-control" name="wick_lookup" value="<?=$filter_user_data['wick_lookup']?>">
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" id="<?php echo $row['setting_id'] ?>trade_percentage" class="form-control" name="trade_percentage" value="<?=$filter_user_data['trade_percentage']?>">
                            ...
                            <div class="col-xs-12">
                              ...
                              <div class="colpanel">
                                  ...
                                  <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>volume_check" name="volume_check" value="yes" <?php if ($filter_user_data['volume_check'] == 'yes') {echo "checked";}?>>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="colpanel">
                                    ...
                                    <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>last_demand_candle" name="last_demand_candle"
                            ...
                            <div class="col-xs-12">
                              ...
                              <div class="colpanel">
                                  ...
                                  <div class="colpanel-h" style="border-bottom:none; margin-bottom:0;">
                                      ...
                                      <input type="checkbox" class="form-check-input" id="<?php echo $row['setting_id'] ?>price_check" name="price_check"
                                    ...
                                    <div class="colpanel-b" style="border-bottom:1px solid #eee; margin-top:15px;">
                                      <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <select id="<?php echo $row['setting_id'] ?>price_symbol" name="price_symbol" type="text" class="form-control filter_by_name_margin_bottom_sm">
    ...
    ?>
                                        ...
                                        <div class="col-xs-12 col-md-3">
                                            ...
                                            <div class="Input_text_s">
                                                ...
                                                <input type="text" class="form-control" id="<?php echo $row['setting_id'] ?>price_to_check" name="price_to_check" value="<?=$filter_user_data['price_to_check']?>">
