...
?>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Candle Status: <br></label>
                     <select class="form-control" id="candle_status" name="candle_status[]" multiple="true">

                       <option value="" <?=$filter_user_data['candle_status'] == '' ? "selected" : ""?>>Select</option>
                       <option value="Continuation_up" <?=$filter_user_data['candle_status'] == 'Continuation_up' ? "selected" : ""?>>Continuation up</option>
                       <option value="Current_up" <?=$filter_user_data['candle_status'] == 'Current_up' ? "selected" : ""?>>Current up</option>
                       <option value="Continuation_Down" <?=$filter_user_data['candle_status'] == 'Continuation_Down' ? "selected" : ""?>>Continuation Down </option>
                       <option value="Current_Down" <?=$filter_user_data['candle_status'] == 'Current_Down' ? "selected" : ""?>>Current Down</option>
                     </select>
                  </div>
               </div>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Global Candle Swing Status: <br></label>
                     <select class="form-control" id="swing_status" name="swing_status[]" multiple="true">
                      <option value="">Select</option>
                       <option value="HH" <?=$filter_user_data['swing_status'] == 'HH' ? "selected" : ""?>>HH</option>
                       <option value="HL" <?=$filter_user_data['swing_status'] == 'HL' ? "selected" : ""?>>HL</option>
                       <option value="LH" <?=$filter_user_data['swing_status'] == 'LH' ? "selected" : ""?>>LH</option>
                       <option value="LL" <?=$filter_user_data['swing_status'] == 'LL' ? "selected" : ""?>>LL</option>
                     </select>
                  </div>
               </div>
               ...
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Candle Type: <br></label>
                     <select class="form-control" id="candle_type" name="candle_type[]" multiple="true">
                       <option value="">Select</option>
                       <option value="demand" <?=$filter_user_data['candle_type'] == 'demand' ? "selected" : ""?>>Demand</option>
                       <option value="supply" <?=$filter_user_data['candle_type'] == 'supply' ? "selected" : ""?>>Supply</option>
                       <option value="normal" <?=$filter_user_data['candle_type'] == 'normal' ? "selected" : ""?>>Normal</option>
                     </select>
                  </div>
               </div>
               <div class="col-xs-12 col-sm-12 col-md-2" style="padding-bottom: 6px;">
               ...
               <!--=================  =================== -->
                <div class="col-xs-12 col-sm-12 col-md-1" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Check Last 24h Candle: <br><small>check for big candle</small></label>
                     ...
                     <label class="form-check-label" for="barrier_check">Check Deep Barrier</label>
                  </div>
               </div>

               <div class="col-xs-12 col-sm-12 col-md-1 candle" style="padding-bottom: 6px; display: none;">
                  <div class="Input_text_s">
                     <label>Deep Candle Range: <br><small>percentage</small></label>
                     <input type="text" class="form-control" name="candle_range" value="<?=$filter_user_data['candle_range']?>">
                  </div>
               </div>
               <div class="col-xs-12 col-sm-12 col-md-1 candle" style="padding-bottom: 6px; display: none;">
                  <div class="Input_text_s">
                     <label>Candle Side: <br><small>duration in hours</small></label>
                      <select class="form-control" name="candle_side">
               ...
               <div class="col-xs-12 col-sm-12 col-md-1 candle" style="padding-bottom: 6px; display: none;">
                  <div class="Input_text_s">
                     <label>Formula: <br><small>formula</small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-1" style="padding-bottom: 6px;">
                  <div class="Input_text_s">
                     <label>Deep Barrier Check: <br><small>check for deep barrier</small></label>
               ...
               <div class="col-xs-12 col-sm-12 col-md-1 deeply" style="padding-bottom: 6px; display: none;">
                  <div class="Input_text_s">
                     <label>Deep Barrier Range: <br><small>range of deep check</small></label>
                     <input type="text" class="form-control" name="deep_price_check" value="<?=$filter_user_data['deep_price_check']?>">
                  </div>
               </div>
               <div class="col-xs-12 col-sm-12 col-md-1 deeply" style="padding-bottom: 6px; display: none;">
                  <div class="Input_text_s">
                     <label>Deep Barrier Lookup: <br><small>duration in hours</small></label>
                     <input type="text" class="form-control" name="deep_price_lookup_in_hours" value="<?=$filter_user_data['deep_price_lookup_in_hours']?>">
                  </div>
               </div>
               <!------------------------------ llllllll ------------------------------>
               <div class="col-xs-12 col-sm-12 col-md-1" style="padding-bottom: 6px;">
               ...
               <div class="col-xs-12 col-sm-12 col-md-1 barrier" style="padding-bottom: 6px; display: none;">
                  <div class="Input_text_s">
                     <label>Barrier Type: <br><small>type of barrier</small></label>
                     <select class="form-control" name="barrier_type">
