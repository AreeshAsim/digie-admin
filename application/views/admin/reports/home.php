    ...
    <div class="innerAll spacing-x2">
        <div class="row">
            <div class="menu-tiles dash-main animated opacity slideInRight" style="opacity: 1;">
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/coin_meta/view_coin_meta" class="btn btn-default custom-btn">
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/barrier_listing" class="btn btn-default custom-btn">
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/indicator_listing" class="btn btn-default custom-btn">
                            <i class="fa fa-map-signs" style="font-size: 35px;text-align: center;"></i>
                            <br> Indicator Listing
                        </a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/order_reports" class="btn btn-default custom-btn">
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/coin_report" class="btn btn-default custom-btn">
                            <i class="fa fa-btc" style="font-size: 35px;text-align: center;"></i>
                            <br> Coin Report
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/meta_coin_report" class="btn btn-default custom-btn">
                            <i class="fa fa-line-chart" style="font-size: 35px;text-align: center;"></i>
                            <br> Barrier Report
                        </a>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/meta_coin_report_percentile" class="btn btn-default custom-btn">
                            <i class="fa fa-bar-chart" style="font-size: 35px;text-align: center;"></i>
                            <br>Percentile Report
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/trigger_report_listing?trigger=barrier" class="btn btn-default custom-btn">
                            <i class="fa fa-cogs" style="font-size: 35px;text-align: center;"></i>
                            <br>Barrier Settings
                        </a>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/trigger_report_listing?trigger=percentile" class="btn btn-default custom-btn">
                            <i class="fa fa-cogs" style="font-size: 35px;text-align: center;"></i>
                            <br>Percentile Settings
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/settings_report_listing?trigger=barrier" class="btn btn-default custom-btn">
                            <i class="fa fa-cogs" style="font-size: 35px;text-align: center;"></i>
                            <br>Barrier Settings Report
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="menu-item animated">
                        <a href="<?php echo SURL; ?>admin/reports/settings_report_listing?trigger=percentile" class="btn btn-default custom-btn">
                            <i class="fa fa-cogs" style="font-size: 35px;text-align: center;"></i>
                            <br>Percentile Settings Report
                        </a>
                    </div>
                </div>
                <div class="col-md-3">
