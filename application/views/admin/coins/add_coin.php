      ...
      <div class="widget-body">
        ...
        <div class="col-md-12">
            <div class="form-group col-md-12">
              <label  class="control-label"for="exchange">Exchnge</label>
             <select class="form-control"name="exchange" id="exchange" class="form-group col-md-12">
          ...
          <div class="col-md-12">
              <div class="form-group col-md-12">
                  <label class="control-label" for="big_contract_base">Big Contract Base</label>
                  <input type="number" class="form-control" name="big_contract_base" value="<?php echo $coin_arr['contract_period']; ?>">
              </div>
          </div>

          <div class="col-md-12">
              <div class="form-group col-md-12">
                  <label class="control-label" for="big_contract_delta_base">Big Contract Delta Base</label>
                  <input type="number" class="form-control" name="big_contract_delta_base">
              </div>
          </div>
