	...
	echo "checked";
        ...
        <div class="col-md-12">
            <div class="form-group col-md-12">
                ...
                <input type="number" class="form-control" name="big_contract_base" value="<?php echo $coin_arr['big_contract_base']; ?>">
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group col-md-12">
                ...
                <input type="number" class="form-control" name="big_contract_delta_base" value="<?php echo $coin_arr['big_contract_delta_base']; ?>">
            </div>
        </div>
