    ...
    <div class="innerAll spacing-x2">
        <div class="widget widget-inverse">
           <div class="widget-head" style="height: 55px;">
            ...
            <a href="https://app.digiebot.com/admin/dashboard/bitcoin_reference" class="btn btn-primary" target="_blank" style="float: right;margin: 10px;">Check Bitcoin Historical Prices</a></div>
