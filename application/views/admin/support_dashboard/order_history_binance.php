...
<div id="content">
  ...
  <ul class="menubar">
  <li class="active"><a href="<?php echo SURL; ?>/admin/dashboard-support/get_binance_user_order_history">Binance Order History</a></li>
  </ul>
  </div>
      ...
      <div class="widget-body padding-bottom-none">
        ...
        <div class="widget widget-inverse">
         <div class="widget-body">
            <form method="POST" action="<?php echo SURL; ?>admin/dashboard-support/get_binance_user_order_history">
              <div class="row">
