    ...
    <div class="widget widget-inverse" style="height:65px;">
      ...
      <div class="widget-body padding-bottom-none filter-colps-body"> 
        ...
        <div class="col-md-12 af-border">
          <form action="<?php echo SURL;?>admin/highchart/candle-report-test"  id="highchartform" enctype="multipart/form-data" method="post">
          ...
          <div class="form-group col-md-1  add_session af-mb-3"> .&nbsp; <a type="submit" class="btn btn-primary btn-block btn-sm savesession" > Save Session </a> <img class="loader_image_main abcdLoader" src="https://app.digiebot.com/assets/images/loader.gif" style="display:none; margin-top: 7px;"> </div>
...
?>>
              ...
              <label class="fncy_check_label"> C M V % </label>
            </div>
