...
<?php if (!empty($faq['Trades'])) {
    ...
    <div class="ask-questions">
    	<a class="ask-popup-trigger" href="javascript:void(0)" data-toggle="modal" data-target="#myModal" title="Ask Your Question"><img src="https://app.digiebot.com/assets/images/dialogue.png" /></a>
    </div>
