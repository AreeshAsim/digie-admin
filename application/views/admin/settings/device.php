...
div.text-success.new_text {color: #0ed42f;font-size: 28px;border-spacing: 63px;vertical-align: middle;margin-top: 32%;text-align: center;}
                ...
                <div class="marvel-device iphone4s silver">
                    ...
                    <div class="screen">
                        <div class="text-center">
                            ...
                            <div class="button-now new_text"> <a href="javascript:void(0)" class="btn btn-success btn-md test">Copy to Clipboard</a></div>
