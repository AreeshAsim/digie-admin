    ...
    for ($i = 0; $i < count($all_coins_arr); $i++) {
        ?>
                  <?php if (in_array($all_coins_arr[$i]['symbol'], $coins_arr)) {?>
                      <option value="<?php echo $all_coins_arr[$i]['_id'] ?>" selected><?php echo $all_coins_arr[$i]['coin_name']; ?></option>
                  <?php } else {?>
                          <option value="<?php echo $all_coins_arr[$i]['_id'] ?>" ><?php echo $all_coins_arr[$i]['coin_name']; ?></option>
                    <?php }
    }
}
?>
