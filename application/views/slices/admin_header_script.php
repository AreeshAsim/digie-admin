...
<link rel="icon" type="image/png" href="https://app.digiebot.com/assets/icons/favicon_ico.ico">
<style>
...
<!-- <div class="tradonof tof-color-red">
	<h2>Trading:<strong>OFF</strong></h2>
</div> -->
<?php if ($this->session->userdata('special_role') == 1) {
  ?>
<!-- <div class="datamissing tof-color-red">
	<h2 id="datamissing"></h2>
</div> -->
<?php }?>
