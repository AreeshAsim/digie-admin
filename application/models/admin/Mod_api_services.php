...
class mod_api_services extends CI_Model {
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" bgcolor="#FFFFFF" valign="top" align="left" style="padding:0px 30px 30px 30px; color:#000000;font-size:16px; mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family:Helvetica Neue, Helvetica, Arial, sans-serif; ">
                                                            ...
                                                            <tr>
                                                            <td>
                                                                <a href="#"><img style="max-width:100%;" src="' . SURL . 'assets/social/facebook.png"> </a>
                                                            </td>
                                                                <td>
                                                                    <a href="#"><img style="max-width:100%;" src="' . SURL . 'assets/social/twitter.png"> </a>
                                                            </td>
                                                            </tr>
                                                            </table>
                                                        </td>
    ...
    public function get_all_coins($id) {
        // $this->db->select('*');
    ...
    public function save_settings_post($data) {
        extract($data);
        if (isset($buy_alerts)) {
    ...
    //get_notifications
    public function get_notifications($admin_id, $time) {
