...
class Mod_candle_dots extends CI_Model
{
	...
	public function report_setting_simulater($global_symbol, $start_date_1, $end_date_1,$filter_search_simulater_sett){
		    
			$this->mongo_db->limit(10);
			//$this->mongo_db->sort(array('created_date' => 1));
			$this->mongo_db->where(array('setting_id'=>$this->mongo_db->mongoId($filter_search_simulater_sett)));//
			...
			//echo "<pre>";  print_r($simulater_report_setting_arr); 	  exit;
			return $simulater_report_setting_arr[0]->result;
	}//simulater_report_setting
	
	
	public function simulater_report_setting($global_symbol){
