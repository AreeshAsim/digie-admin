...
Class Mongo_db_3 {
    ...
    function __construct($param = array()) {
        ...
        $this->CI->load->config('mongo_db_binance_data');
    ...
    private function connect() {
        ...
        try {
            ...
            //$url = "mongodb://digiedb:digiedb%$#@!@{$this->hostname}:{$this->port}/?authMechanism=SCRAM-SHA-1&authSource=binance";

            //$url = "mongodb://digiedb:digiedb%25%24%23%40!@3.225.96.166:27017/?authMechanism=SCRAM-SHA-1&authSource=binance";

            //$url = "mongodb://3.225.96.166:27017/binance";

            // $url = "mongodb://root:95bcqr1Vizz@digiebot-shard-00-00-bhelp.mongodb.net:27017,digiebot-shard-00-01-bhelp.mongodb.net:27017,digiebot-shard-00-02-bhelp.mongodb.net:27017/test?ssl=true&replicaSet=Digiebot-shard-0&authSource=admin&retryWrites=true&w=majority";
            $url = 'mongodb+srv://root:95bcqr1Vizz@bam-bhelp.mongodb.net/test?authSource=admin&replicaSet=bam-shard-0&w=majority&readPreference=primary&appname=MongoDB%20Compass%20Community&retryWrites=true&ssl=true';
