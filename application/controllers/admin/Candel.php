...
class Candel extends CI_Controller {
    ...
    //     $periods = '1h';
    //     $order_data = array();
    //     $candel_stick_arr_ = $this->mod_candel->get_candelstick_data_from_database($global_symbol, $periods);
    ...
    //     //$order_data = $this->mod_candel->get_order_array($global_symbol, $admin_id, $global_mode, $start_date_for_time_zone_time, $end_date_for_time_zone_time);
    //     $task_manager_setting_arr = $this->mod_candel->get_task_manager_setting($global_symbol);
    ...
    //     $draw_target_zone_arr = $this->mod_candel->get_chart_target_zones($global_symbol);
    ...
    //             $get_market_history_for_candel = $this->mod_candel->get_candle_price_volume_detail($global_symbol, $start_date, $end_date, $unit_value);
    ...
    //     $all_candle_volume_detail = $this->mod_candel->get_candle_price_volume_detail($global_symbol, $from_date_for_candel, $end_date_for_candel, $unit_value = 0);
    ...
    //         $is_box_trade_buy = $this->is_box_trigger_trade_buyed($start_date_1, $end_date_1, $global_symbol);
    ...
    //         $down_status = $this->mod_candel->calculate_pressure_up_and_down($start_date_1, $end_date_1, $candel_stick_single_arr['coin'], $pressure_type = 'down');
    //         $up_status = $this->mod_candel->calculate_pressure_up_and_down($start_date_1, $end_date_1, $candel_stick_single_arr['coin'], $pressure_type = 'up');
    //         $avg_score = $this->mod_candel->calculate_average_score($candel_stick_single_arr['coin'], $start_date_1, $end_date_1);
    ...
    //     $this->stencil->paint('admin/dashboard/candlesdtick_dyamic_7', $data);
    ...
    //     $candel_stick_arr_ = $this->mod_candel->get_candelstick_data_from_database($global_symbol, $periods, $from_date_object, $to_date_object, $previous_date, $forward_date);
    ...
    //             $status_arrr = $this->mod_candel->sma_of_pressure($start_date_1, $end_date_1, $candel_stick_single_arr['coin'], $sma_offset);
    //             $up_status = $status_arrr['up_sma'];
    //             $down_status = $status_arrr['down_sma'];

    //         }

    //         $calculate_up_down_wall = $this->mod_candel->calculate_up_down_wall($candel_stick_single_arr['coin'], $start_date_1);
    ...
    //     $this->mod_candel->delete_data_from_data_base();
    ...
    //     $this->mod_candel->save_task_manager_setting($this->input->post(), $global_symbol);
    ...
    //     $this->mod_candel->calculate_pressure_up_and_down();
    //     exit();
    ...
    //     $where['buy_date'] = array('$gte' => $start_date, '$lte' => $end_date);
    //     $where['symbol'] = $symbol;
