...
class Candle_chart extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('admin/mod_candle_chart');
    ...
    //     $order_data = $this->mod_candle_chart->get_order_array($global_symbol, $admin_id, $global_mode);

    //     $candel_stick_arr = $this->mod_candle_chart->get_candelstick_data_from_database($global_symbol, $periods);
    ...
    //     $task_manager_setting_arr = $this->mod_candle_chart->get_task_manager_setting($global_symbol);
    ...
    //     $draw_target_zone_arr = $this->mod_candle_chart->get_chart_target_zones($global_symbol);
    ...
    //             $get_market_history_for_candel = $this->mod_candle_chart->get_candle_price_volume_detail($global_symbol, $start_date, $end_date, $unit_value);
    ...
    //     $all_candle_volume_detail = $this->mod_candle_chart->get_candle_price_volume_detail($global_symbol, $from_date_for_candel, $end_date_for_candel, $unit_value = 0);

    //     $all_Hour_candle_volume_detail = $this->mod_candle_chart->get_hour_volume_array_detail($global_symbol, $from_date_for_candel, $end_date_for_candel);
    ...
    //         $start_date_1 = date("Y-m-d H:i:00", $openTime_current_time_zone / 1000);

    //         $end_date_1 = date("Y-m-d H:i:59", strtotime("+15 minutes", $openTime_current_time_zone / 1000));

    //         $down_status = $this->mod_candle_chart->calculate_pressure_up_and_down($start_date_1, $end_date_1, $candel_stick_single_arr['coin'], $pressure_type = 'down');

    //         $up_status = $this->mod_candle_chart->calculate_pressure_up_and_down($start_date_1, $end_date_1, $candel_stick_single_arr['coin'], $pressure_type = 'up');

    //         $calculate_up_down_wall = $this->mod_candle_chart->calculate_up_down_wall($candel_stick_single_arr['coin'], $start_date_1);
    ...
    //         //$calculated_array = $this->mod_candle_chart->get_all_indicators_from_last_week($global_symbol,$start_date_1);
    //         $indicator_arr = $this->mod_candle_chart->get_all_indicators($global_symbol, $start_date_1, $end_date_1);
    //         $black_arr = $indicator_arr['blackwall'];
    //         $sevn_arr = $indicator_arr['sevenlevel'];
    //         $bid_arr = $indicator_arr['bid_quantity'];
    //         $ask_arr = $indicator_arr['ask_quantity'];

    //         $last_qty_buy_vs_sell = $indicator_arr['last_qty_buy_vs_sell'];
    //         $last_200_buy_vs_sell = $indicator_arr['sellers_buyers_per'];
    //         $last_qty_time_ago = $indicator_arr['last_qty_time_ago'];

    //         foreach ($black_arr as $key => $value) {
    //             if ($candel_stick_single_arr['black_wall_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['black_wall_percentile'] <= (float) $value) {
    //                     $candel_stick_single_arr['blackwall'] = "true";
    //                     $candel_stick_single_arr['blackwall_percentile'] = $value;
    //                     break;
    //                 } else {
    ...
    //         foreach ($sevn_arr as $key => $value) {
    //             if ($candel_stick_single_arr['seven_level_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['seven_level_percentile'] <= (float) $value) {
    //                     $candel_stick_single_arr['sevenlevel'] = "true";
    //                     $candel_stick_single_arr['sevenlevel_percentile'] = $value;
    //                     break;
    //                 } else {
    ...
    //         foreach ($bid_arr as $key => $value) {
    //             if ($candel_stick_single_arr['bid_val_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['bid_val_percentile'] <= (float) $value) {
    //                     $candel_stick_single_arr['bid_quantity'] = "true";
    //                     $candel_stick_single_arr['bid_percentile'] = $value;
    //                     break;
    //                 } else {
    ...
    //         foreach ($ask_arr as $key => $value) {
    //             if ($candel_stick_single_arr['ask_val_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['ask_val_percentile'] <= (float) $value) {
    //                     $candel_stick_single_arr['ask_quantity'] = "true";
    //                     $candel_stick_single_arr['ask_percentile'] = $value;
    //                     break;
    //                 } else {
    ...
    //         foreach ($last_qty_buy_vs_sell as $key => $value) {
    //             if ($candel_stick_single_arr['last_qty_buy_vs_sell_val_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['last_qty_buy_vs_sell_val_percentile'] <= (float) $value) {
    //                     $candel_stick_single_arr['last_qty_buy_vs_sell'] = "true";
    //                     $candel_stick_single_arr['last_qty_buy_vs_sell_percentile'] = $value;
    //                     break;
    //                 } else {
    //                     $candel_stick_single_arr['last_qty_buy_vs_sell'] = "false";
    //                     $candel_stick_single_arr['last_qty_buy_vs_sell_percentile'] = $value;
    //                 }
    //             }
    //         }

    //         foreach ($last_200_buy_vs_sell as $key => $value) {
    //             if ($candel_stick_single_arr['fivemin_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['fivemin_percentile'] <= (float) $value) {
    //                     $candel_stick_single_arr['last_200_buy_vs_sell'] = "true";
    //                     $candel_stick_single_arr['last_200_buy_vs_sellpercentile'] = $value;
    //                     break;
    //                 } else {
    //                     $candel_stick_single_arr['last_200_buy_vs_sell'] = "false";
    //                     $candel_stick_single_arr['last_200_buy_vs_sellpercentile'] = $value;
    //                 }
    //             }
    //         }
    ...
    //         foreach ($last_qty_buy_vs_sell as $key => $value) {
    //             if ($candel_stick_single_arr['last_qty_sell_vs_buy_val_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['last_qty_sell_vs_buy_val_percentile'] >= (float) $value) {
    //                     $candel_stick_single_arr['last_qty_sell_vs_buy'] = "true";
    //                     $candel_stick_single_arr['last_qty_sell_vs_buy_percentile'] = $value;
    //                     break;
    //                 } else {
    //                     $candel_stick_single_arr['last_qty_sell_vs_buy'] = "false";
    //                     $candel_stick_single_arr['last_qty_sell_vs_buy_percentile'] = $value;
    //                 }
    //             }
    //         }
    ...
    //         foreach ($last_200_buy_vs_sell as $key => $value) {
    //             if ($candel_stick_single_arr['fivemin_b_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['fivemin_b_percentile'] >= (float) $value) {
    //                     $candel_stick_single_arr['last_200_sell_vs_buy'] = "true";
    //                     $candel_stick_single_arr['last_200_sell_vs_buy_percentile'] = $value;
    //                     break;
    //                 } else {
    //                     $candel_stick_single_arr['last_200_sell_vs_buy'] = "false";
    //                     $candel_stick_single_arr['last_200_sell_vs_buy_percentile'] = $value;
    //                 }
    //             }
    //         }

    //         foreach ($last_qty_time_ago as $key => $value) {
    //             if ($candel_stick_single_arr['last_qty_time_ago_val_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['last_qty_time_ago_val_percentile'] >= (float) $value) {
    //                     $candel_stick_single_arr['last_qty_time_ago'] = "true";
    //                     $candel_stick_single_arr['last_qty_time_ago_percentile'] = $value;
    //                     break;
    //                 } else {
    //                     $candel_stick_single_arr['last_qty_time_ago'] = "false";
    //                     $candel_stick_single_arr['last_qty_time_ago_percentile'] = $value;
    //                 }
    //             }
    //         }
    ...
    //     $this->stencil->paint('admin/candle_stick/candlesdtick_dyamic_7', $data);
    ...
    //     $candel_stick_arr = $this->mod_candle_chart->get_candelstick_data_from_database($global_symbol, $periods, $from_date_object, $to_date_object, $previous_date, $forward_date);
    ...
    //         $last_qty_buy_vs_sell = $indicator_arr['last_qty_buy_vs_sell'];
    //         $last_200_buy_vs_sell = $indicator_arr['last_200_buy_vs_sell'];
    //         $last_qty_time_ago = $indicator_arr['last_qty_time_ago'];
    ...
    //         foreach ($last_200_buy_vs_sell as $key => $value) {
    //             if ($candel_stick_single_arr['last_200_buy_vs_sell_val_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['last_200_buy_vs_sell_val_percentile'] <= (float) $value) {
    //                     $candel_stick_single_arr['last_200_buy_vs_sell'] = "true";
    //                     $candel_stick_single_arr['last_200_buy_vs_sellpercentile'] = $value;
    //                     break;
    //                 } else {
    ...
    //         foreach ($last_200_buy_vs_sell as $key => $value) {
    //             if ($candel_stick_single_arr['last_200_sell_vs_buy_val_percentile'] != NULL) {
    //                 if ((float) $candel_stick_single_arr['last_200_sell_vs_buy_val_percentile'] >= (float) $value) {
    //                     $candel_stick_single_arr['last_200_sell_vs_buy'] = "true";
    //                     $candel_stick_single_arr['last_200_sell_vs_buy_percentile'] = $value;
    //                     break;
    //                 } else {
    ...
    //     $this->mod_candle_chart->delete_data_from_data_base();
    ...
    //     echo $update_candels = $this->mod_candle_chart->update_candel_for_formul_values($data, $global_symbol);
    ...
    //     $this->mod_candle_chart->save_task_manager_setting($this->input->post(), $global_symbol);
    ...
    // public function save_candles_fifteen_minutes() {
    ...
    //                 $date_for_candel = date('Y-m-d H:i:00', strtotime('-15 minutes'));
    ...
    //                 ////////////////////////////////////////////////////////////////////////////////////////////////////////
    //                 $percentile_arr = $this->save_fifteen_minute_coin_percentile($coin_symbol);

    //                 /////////////////////////////////////////////////////////////////////////////////////////////////////////
    //                 ///////////////////////END Calculation of Percentile/////////////////////
    //                 ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //                     'blackwall_percentile' => $percentile_arr['blackwall_10'],

    //                     'sevenlevel_percentile' => $percentile_arr['sevenlevel_10'],

    //                     'fivemin_percentile' => $percentile_arr['five_min_10'],

    //                     'fivemin_b_percentile' => $percentile_arr['five_min_b_10'],

    //                     'ask_percentile' => $percentile_arr['ask_quantity_10'],

    //                     'bid_percentile' => $percentile_arr['bid_quantity_10'],

    //                     'last_200_buy_vs_sell_percentile' => $percentile_arr['last_200_buy_vs_sell_10'],

    //                     'last_qty_buy_vs_sell_percentile' => $percentile_arr['last_qty_buy_vs_sell_10'],

    //                     'last_qty_time_ago_percentile' => $percentile_arr['last_qty_time_ago_10'],

    //                     'last_200_sell_vs_buy_percentile' => $percentile_arr['last_200_sell_vs_buy_10'],

    //                     'last_qty_sell_vs_buy_percentile' => $percentile_arr['last_qty_sell_vs_buy_10'],
    ...
    //                     $this->mongo_db->insert('market_chart_fifteen_minutes', $insert22);
    ...
    //     }
    //     $summary = "This cronjob Run for record the fifteen minute candles";
    //     $duration = "15 minutes";
    ...
    //         $datetime = date('Y-m-d G:i:00', strtotime('- 15 minutes'));
    ...
    //     }
    //     $summary = "This cronjob Run for record the fifteen minutes volume for candle";
    //     $duration = "15 minutes";
    //     track_execution_of_cronjob($duration, $summary);

    // }
    // public function save_fifteen_minute_coin_percentile($symbol) {
    //     $this->mongo_db->where(array('coin' => $symbol));
    //     $get = $this->mongo_db->get('coin_meta_hourly_percentile');
    //     $ret_arr = iterator_to_array($get);
    //     return $ret_arr[0];
    // }
    ...
    //     $get = $this->mongo_db->get('market_chart_fifteen_minutes');
    ...
    //     $previouse_candel_result = $this->mongo_db->get('market_chart_fifteen_minutes');
    ...
    //     $prevouse_date = date('Y-m-d H:i:00', strtotime('-15 minutes', strtotime($date_for_candel)));
    ...
    //     $response_detail = $this->mongo_db->get('market_chart_fifteen_minutes');
    ...
    //     $market_chart_object = $this->mongo_db->get('market_chart_fifteen_minutes');
