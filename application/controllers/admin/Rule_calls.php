...
class Rule_calls extends CI_Controller
{
    ...
    public function rules_display(){
        ...
        CURLOPT_PORT => "2603",
        CURLOPT_URL => "http://3.232.17.202:2603/apiEndPoint/getcoinsrule15status",
    ...
    public function update_rule(){
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => "3.232.17.202:2603/apiEndPoint/setrulelevel15",
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
          CURLOPT_MAXREDIRS => 10,
          CURLOPT_TIMEOUT => 0,
    ...
    public function balaceTest(){
        ...
        $order_history = $this->binance_api->get_account_balance_user($user_id);

        echo "<pre>";print_r($order_history);
