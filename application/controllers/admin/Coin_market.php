...
class Coin_market extends CI_Controller {
    ...
    //     $this->stencil->paint('admin/coin_market/coin_market', $data);
    // }
    ...
    //     if ($balance == null) {
    //         $balance = 0; //"<p style='color:red;'>Set Your Api Key</p>";
    //     }
    //     if ($coin != "BTC") {
    //         $price = $this->mod_market->get_last_price($coin);
    //         $per = $change['percentage'];
    //         $amount1 = $change['change'];
    //         if ($per > 0) {
    //             $amount = '<b><span style="color:green;">' . num($amount1) . '(' . number_format($per, 2) . '%)' . '</span></b>';
    ...
    //             $amount = '<b><span style="color:dark-grey;">' . num($amount1) . '(' . number_format($per, 2) . '%)' . '</span></b>';
    //         }
    //         $trade = $this->mod_market->get_market_trades($coin);
    //     } else {
    //         $price = 1;
    //         $trade = 'N/A';
    //     }
    ...
    //     $data['news'] = $news;
    //     $this->stencil->paint('admin/coin_market/coin_detail', $data);
    // }
