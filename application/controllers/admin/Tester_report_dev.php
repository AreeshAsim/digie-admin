 ...
 *
 */
class Tester_report_dev extends CI_Controller {
    ...
    //     $this->stencil->paint('admin/reports/meta_report_2_dev', $data);
    // }
    ...
    // public function step_two_test($symbol = "NEOBTC", $start_date = "2019-07-10 07:00:00", $end_date = "2019-07-10 08:00:00") {
    //     $start = date("Y-m-d H:00:00", strtotime("-1 hour", strtotime($start_date)));
    ...
    //             echo " Price is in Top Wick at Index " . $i . " and price is " . $price . "<br>";
    //             $top = true;
    //             break;
    //         }
    //     }
    ...
    //     } else {
    //         echo $curr_hr_percentile = '2';

    //         $test = $this->check_current_hour_contract_less_close_last_candle($start_date, $curr_hr_percentile, $symbol, $close);
    //     }
