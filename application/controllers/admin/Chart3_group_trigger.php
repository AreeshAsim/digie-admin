...
//         $rolling1 = $this->get_rolling_candle_volume_fifteen($symbol, $pre_time);
...
//         $contract_three = $this->get_contracts_three($symbol, $pre_time);
//         $contract_four = $this->get_contracts_four($symbol, $pre_time);
...
//     } //end autoload_trading_chart_data222
    ...
    // public function get_rolling_candle_volume_fifteen($symbol, $datetime) {
    //     $datetime = date("Y-m-d H:i:s", strtotime('-15 minutes', strtotime($datetime)));
    ...
    //         $time2 = $this->time_elapsed_string_min($new_time, $pre_time);
...
//         return $array;
    ...
    // public function get_contracts_three($symbol, $pre_time) {
    //     $contract_size_arr = $this->get_log_val($symbol, $pre_time, 'size');
    //     $contract_size = $contract_size_arr['old_contract_size'];
    ...
    // public function get_contracts_four($symbol, $pre_time) {
    ...
    // public function get_percentile_history($symbol = "NCASHBTC", $pre_time) {
    //     $date = date("Y-m-d H:i:s");
    //     $date_q = $this->roundToQuarterHour($date);

    //     $full_date = date("Y-m-d H:" . $date_q . ":00");

    //     $this->mongo_db->where(array("coin" => $symbol, "timestampDate" => $this->mongo_db->converToMongodttime($full_date)));
    //     $get_object = $this->mongo_db->get("market_chart_fifteen_minutes");

    //     return iterator_to_array($get_object);
    // }
    ...
    // public function getTopPercent($topPerArr, $symbol, $pre_time) {

    //     $pretime = date("Y-m-d H:00:00", strtotime($pre_time));
    ...
    //     $this->mongo_db->order_by(array('_id' => -1));
    //     $this->mongo_db->where(array('coin' => $symbol, 'modified_time' => $this->mongo_db->converToMongodttime($pretime)));
    //     $this->mongo_db->limit(1);
    //     $row = $this->mongo_db->get('coin_meta_hourly_percentile_history');
