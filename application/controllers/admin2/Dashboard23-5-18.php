...
class Dashboard extends CI_Controller {
	...
	{	
		...
		$ins_data['market_value'] = '0.00000417';
		$ins_data['status'] = 'FILLED';
		$ins_data['binance_order_id'] = '7876888';
...
*/
	...
	public function sell_order(){
		...
		if($order_arr['status'] =='new'){
			...
			$this->mod_dashboard->binance_sell_auto_market_order($id,$quantity,$market_value,$symbol,$user_id);
	...
	public function buy_order(){
		...
		$this->mod_dashboard->binance_buy_auto_market_order($id,$quantity,$market_value,$symbol,$user_id);

		//$orders_arr = $this->mod_dashboard->buy_order($id,$market_value);
	...
	public function autoload_market_statistics()
	{
		...
		//Get Coin Balance
		$coin_balance = $this->mod_dashboard->get_coin_balance();
	...
	public function autoload_notifications(){
		
		$notifications = $this->mod_dashboard->get_notifications();
