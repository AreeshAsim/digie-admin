...
class Candel extends CI_Controller {
	...
	public function run() {
		...
		//$order_data = $this->mod_candel->get_order_array($global_symbol,$admin_id,$global_mode);

		$order_data = array();
		$candel_stick_arr = $this->mod_candel->get_candelstick_data_from_database($global_symbol, $periods);
	...
	public function autoload_candle_stick_data_from_database_ajax() {
		...
		$candel_stick_arr = $this->mod_candel->get_candelstick_data_from_database($global_symbol, $periods, $from_date_object, $to_date_object, $previous_date, $forward_date);
