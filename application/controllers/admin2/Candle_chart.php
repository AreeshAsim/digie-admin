	...
	public function index() {
		...
		foreach ($candel_stick_arr as $candel_stick_single_arr) {
			...
			foreach ($black_arr as $key => $value) {
				if ((float)$calculated_array['blackwall_10'] <= (float)$value) {
			...
			foreach ($sevn_arr as $key => $value) {
				if ((float)$calculated_array['sevenlevel_10'] <= (float)$value) {
			...
			foreach ($bid_arr as $key => $value) {
				if ((float)$calculated_array['bid_quantity_10'] <= (float)$value) {
			...
			foreach ($ask_arr as $key => $value) {
				if ((float)$calculated_array['ask_quantity_10'] <= (float)$value) {
			...
			foreach ($last_qty_buy_vs_sell as $key => $value) {
				if ((float)$calculated_array['last_qty_buy_vs_sell_10'] <= (float)$value) {
			...
			foreach ($last_200_buy_vs_sell as $key => $value) {
				if ((float)$calculated_array['last_200_buy_vs_sell_10'] <= (float)$value) {
			...
			foreach ($last_qty_buy_vs_sell as $key => $value) {
				if ((float)$calculated_array['last_qty_sell_vs_buy_10'] >= (float)$value) {
			...
			foreach ($last_200_buy_vs_sell as $key => $value) {
				if ((float)$calculated_array['last_200_sell_vs_buy_10'] >= (float)$value) {
			...
			foreach ($last_qty_time_ago as $key => $value) {
				if ((float)$calculated_array['last_qty_time_ago_10'] >= (float)$value) {
